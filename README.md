...
- `public static void main(String[] args)` is a wild way to begin a program
- I like the `//` commenting style
- `System.out.println(\textit{text});` is so long and unnecessary, like just make it print
- the variable assignment is actually not that different from Python
- a lot more whitespace than conventional Python I would say
...
If you don't get the right answer, that's okay for now. (It is 466).
